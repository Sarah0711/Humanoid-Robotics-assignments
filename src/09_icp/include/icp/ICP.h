...
/**
 * \brief Implements the Iterative Closest Point (ICP) algorithm in 2D.
 */
class ICP 
{
public:
	...
	static double minDistance(const std::vector<double>& dist);
	...
	static StdVectorOfVector2d iterateOnce(const StdVectorOfVector2d& Q, const StdVectorOfVector2d& P, bool & conversionFlag, const bool pointToLineFlag,double threshold);
};
